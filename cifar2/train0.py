...
train_set = datasets.CIFAR10(root="../web_course/cifar",train=True,download=False,transform=transform_train)
test_set = datasets.CIFAR10(root="../web_course/cifar",train=False,download=False,transform=transform_test)
