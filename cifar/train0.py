...
train_set = datasets.CIFAR10(root="../web_course/cifar",train=True,download=True,transform=transform_train)
test_set = datasets.CIFAR10(root="../web_course/cifar",train=False,download=True,transform=transform_test)
